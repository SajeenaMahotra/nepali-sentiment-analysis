              ...
              {MODELS.map((m) => (
                ...
                >
                  ...
                  <span className="flex items-center gap-1.5 ml-2 shrink-0">
                    ...
                    {m.best && (
                      <span className="bg-emerald-500 text-white text-[9px] px-1.5 py-0.5 rounded-full font-bold">BEST</span>
                    )}
                  </span>
                </button>
              ))}
        ...
        <div className="flex-1 flex items-center justify-center p-8">
          <div className="w-full max-w-lg space-y-7">
            <div className="space-y-1.5">
              <h1 className="text-4xl font-semibold tracking-tight text-white">Analyze a Review</h1>
              <p className="text-white/40 text-sm">Paste a product review to classify its sentiment.</p>
            </div>
            ...
            {result && config && (
              <div className={`bg-white/5 backdrop-blur-sm border ${config.border} rounded-xl p-6 space-y-5 shadow-xl ${config.glow}`}>
                ...
                <p className={`text-5xl font-bold tracking-tight ${config.accent}`}>{config.label}</p>
